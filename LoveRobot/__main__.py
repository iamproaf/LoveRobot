...
from LoveRobot.modules import ALL_MODULES
from LoveRobot.modules.helper_funcs.chat_status import is_user_admin
from LoveRobot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴛɢɴ ʀᴏʙᴏᴛ ᴛᴏ ᴜʀ ᴄʜᴀᴛ", url="t.me/Florina_test_xx_bot?startgroup=true"),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("LoveRobot.modules." + module_name)
