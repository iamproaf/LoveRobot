...
import LoveRobot.modules.sql.global_bans_sql as gban_sql
import LoveRobot.modules.sql.users_sql as user_sql
from LoveRobot import DEV_USERS, OWNER_ID, dispatcher
