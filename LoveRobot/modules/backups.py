...
import LoveRobot.modules.sql.notes_sql as sql
from LoveRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from LoveRobot.__main__ import DATA_IMPORT
from LoveRobot.modules.helper_funcs.chat_status import user_admin
from LoveRobot.modules.helper_funcs.alternate import typing_action

# from LoveRobot.modules.rules import get_rules
import LoveRobot.modules.sql.rules_sql as rulessql

# from LoveRobot.modules.sql import warns_sql as warnssql
import LoveRobot.modules.sql.blacklist_sql as blacklistsql
from LoveRobot.modules.sql import disable_sql as disabledsql

# from LoveRobot.modules.sql import cust_filters_sql as filtersql
# import LoveRobot.modules.sql.welcome_sql as welcsql
import LoveRobot.modules.sql.locks_sql as locksql
from LoveRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("LoveRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("LoveRobot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `LoveRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("LoveRobot{}.backup".format(chat_id))  # Cleaning file
