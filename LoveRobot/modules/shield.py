...
from LoveRobot.utils.pluginhelpers import is_admin
from LoveRobot.events import register
from LoveRobot.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from LoveRobot import telethn, MONGO_DB_URI, BOT_ID
...
__help__ = """
• LoveRobot can protect your group from NSFW senders, Slag word users and also can force members to use English
